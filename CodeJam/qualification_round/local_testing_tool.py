...
class JudgeSingleCase(object):
  ...
  def Judge(self):
    ...
    for i in range(MAX_QUERIES + 1):
      ...
      #   if print_bool:
      #     tmp_string=tmp_string+str(self.arr)+"\n"
      # if print_bool:
      #   tmp_string=tmp_string+str(contestant_input)+" "+str(self.arr[contestant_input-1])+"\n"
...
def JudgeAllCases(test_number, io):
  ...
  for case_number in range(NUM_CASES):
    ...
    # print_bool=bool(case_number == 75)
